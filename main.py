...
class Game:
    ...
    def if_collided(self):
        ...
        def check_diagonally(ball, rect):
        ...
        if pygame.sprite.spritecollide(self.ball, self.all_enemy, False):
    ...
    def intro_draw(self):
        ...
        self.screen.blit(self.start_txt,
                         (320 - (tile_size * 4 + 15) - self.x_hover,
